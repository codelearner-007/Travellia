  ...
  return (
    <section className="relative lg:min-h-[115vh] flex items-end justify-end">
      ...
      >
        ...
        <div className="py-8 px-8 sm:p-16 mx-5 sm:mx-0  rounded-3xl shadow-2xl flex items-center justify-center gap-6 bg-gray-200 w-[90%] sm:w-full absolute -bottom-40">
            ...
            {STATS.map((stat, index) => (
              <React.Fragment key={index}>
                <div className="flex flex-col items-center text-center ">
                  ...
                  <h2 className="text-5xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3">
                    {stat.number}
                  </h2>
